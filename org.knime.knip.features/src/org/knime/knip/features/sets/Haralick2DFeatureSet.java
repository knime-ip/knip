...
public class Haralick2DFeatureSet<T extends RealType<T>, O extends RealType<O>>
	...
	@Parameter(type = ItemIO.INPUT, label = "Number Grey Levels", description = "The number of grey values determines the size of the co-occurence matrix on which the Haralick features are calculated.", min = "1", max = "2147483647", stepSize = "1")
