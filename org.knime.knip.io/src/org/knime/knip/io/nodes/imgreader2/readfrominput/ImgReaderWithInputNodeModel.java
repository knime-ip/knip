...
public class ImgReaderWithInputNodeModel<T extends RealType<T> & NativeType<T>> extends AbstractImgReaderNodeModel<T> {
	...
	private static final NodeLogger LOGGER = NodeLogger.getLogger(ImgReaderWithInputNodeModel.class);
	...
	public ImgReaderWithInputNodeModel() {
		super(1, 1);
	...
	protected BufferedDataTable[] execute(BufferedDataTable[] inData, ExecutionContext exec) throws Exception {
		...
		ReadImgWithInputFunction<T> rifp = new ReadImgWithInputFunction<T>(exec, inData[0].getRowCount(), m_planeSelect,
