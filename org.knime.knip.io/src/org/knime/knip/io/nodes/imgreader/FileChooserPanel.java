...
public class FileChooserPanel extends JPanel {
    ...
    public FileChooserPanel(final FileFilter fileFilter) {
        ...
        m_addAllButton =
                new JButton("Add all visible files", new ImageIcon(getClass()
                        .getResource("edit_add.png")));
        m_remButton =
                new JButton("Remove selected", new ImageIcon(getClass()
                        .getResource("editdelete.png")));
        m_remAllButton =
                new JButton("Remove all Files", new ImageIcon(getClass()
                        .getResource("edit_remove.png")));
        m_selectedFileList = new JList();
        m_selectedFileListModel = new FileListModel();
        m_selectedFileListBorder =
                BorderFactory.createTitledBorder("Selected files");
        ...
        final JMenuItem add =
                new JMenuItem("Add selected File", new ImageIcon(getClass()
                        .getResource("button_ok.png")));
        ...
        final JMenuItem addAll =
                new JMenuItem("Add all visible files", new ImageIcon(getClass()
                        .getResource("edit_add.png")));
        ...
        final JMenuItem clearSelection =
                new JMenuItem("Remove All", new ImageIcon(getClass()
                        .getResource("edit_remove.png")));
        ...
        final JMenuItem remove =
                new JMenuItem("Remove Selected", new ImageIcon(getClass()
                        .getResource("editdelete.png")));
        ...
        m_selectedFileList.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(final MouseEvent arg0) {
                if (arg0.getClickCount() == 2) {
                    ...
                    final File dir =
                            new File(m_selectedFileListModel
