 ...
 */
public class LabelingEditorRemoveAllEvent implements KNIPEvent {

	private final Set<String> m_delete;

	public LabelingEditorRemoveAllEvent(final Set<String> deletedLabels) {
