...
public class DialogComponentAnnotator<T extends RealType<T> & NativeType<T>> extends DialogComponent {
	 ...
	 * 
	 */
	public DialogComponentAnnotator(final SettingsModelAnnotator model, final String... initialClasses) {
		super(model);
	...
	private void createAnnotator(final String... defaultLabels) {
		...
		m_annotator.addViewerComponent(new AWTImageProvider(0, new OverlayRU<String>(new ImageRU<T>(0.0))));
	...
	protected void updateComponent() {
		try {
			m_annotator.reset();
			m_annotator.setComponentConfiguration(((SettingsModelAnnotator) getModel()).getBase64CodedImgViewer());
	...
	protected void validateSettingsBeforeSave() throws InvalidSettingsException {
		try {
			((SettingsModelAnnotator) getModel()).setOverlayMapAndComponents(m_annotator.getComponentConfiguration(),
