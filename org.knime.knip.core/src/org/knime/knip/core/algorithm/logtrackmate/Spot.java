...
public class Spot {
     ...
     * Instantiate a Spot.
     * <p>
     * The given coordinate double array <b>must</b> have 3 elements. If the 3rd one is not used (2D case), it can be
     ...
     * @param feature The feature string to retrieve the stored value for. <code>null</code> if it has not been set.
     */
    ...
    /**
     * @return the absolute normalized difference of the feature value of this spot with the one of the given spot.
     *         <p>
     *         If <code>a</code> and <code>b</code> are the feature values, then the absolute normalized difference is
     *         defined as <code> Math.abs( a - b) / ( (a+b)/2 )</code>.
     *         <p>
