...
public class QuadraticSubpixelLocalization<T extends RealType<T>> implements Algorithm, Benchmark, MultiThreaded {
    ...
    public boolean analyzePeak(final SubPixelLocalization<T> peak) {
        ...
        Img<DoubleType> hessianMatrix =
                doubleArrayFactory.create(new int[]{cursor.numDimensions(), cursor.numDimensions()}, new DoubleType());
     ...
     *            size [numDimensions]
     */
    final public static <T extends RealType<T>> void computeDerivativeVector(final RandomAccess<T> cursor,
                                                                             final Img<DoubleType> derivativeVector) {
    ...
    final public static <T extends RealType<T>> Img<DoubleType> computeHessianMatrix(final RandomAccess<T> cursor) {
        final ImgFactory<DoubleType> factory = new ArrayImgFactory<DoubleType>();
        final Img<DoubleType> hessianMatrix =
                factory.create(new int[]{cursor.numDimensions(), cursor.numDimensions()}, new DoubleType());
     ...
     *            {@link Img} of size [numDimensions][numDimensions]
     */
    final public static <T extends RealType<T>> void computeHessianMatrix(final RandomAccess<T> cursor,
                                                                          final Img<DoubleType> hessianMatrix) {
