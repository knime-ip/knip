 ...
 */
public class LinearSpaceExt0 implements Externalizer<DefaultLinearSpace> {
     ...
     */
    @Override
    public Class<DefaultLinearSpace> getType() {
     ...
     */
    @Override
    public DefaultLinearSpace read(final BufferedDataInputStream in) throws Exception {
        final int numDims = in.readInt();
        final DefaultLinearSpace res = new DefaultLinearSpace(numDims);
     ...
     */
    @Override
    public void write(final BufferedDataOutputStream out, final DefaultLinearSpace obj) throws Exception {
