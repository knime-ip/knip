 ...
 */
public class JEPExp extends Exp implements ImgOpEvalRequired {
    ...
    @Override
    public Object exp(final Object param) throws ParseException {
        if (param instanceof Number) {
            return super.exp(param);
        } else if (param instanceof Img) {
            return m_imgOpEval.doImgUnaryOperation((Img)param, new RealExp());
        }
