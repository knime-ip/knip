...
/**
 * {@link NodeFactory} for {@link DoGDetector3NodeFactory} wrapping the {@link DogDetection}
 *
 * @param <T>
 *
 * @author <a href="mailto:dietzc85@googlemail.com">Christian Dietz</a>
 */
public class DoGDetector3NodeFactory<T extends RealType<T> & NativeType<T>> extends
        ImgPlusToImgPlusNodeFactory<T, BitType> {

    static SettingsModelDouble createSigma2Model() {
        return new SettingsModelDoubleBounded("sigma2_value", 5, 0.001, Double.MAX_VALUE);
    }

    static SettingsModelDouble createSigma1Model() {
        return new SettingsModelDoubleBounded("sigma1_value", 3, 0.001, Double.MAX_VALUE);
    }
        ...
        return new ImgPlusToImgPlusNodeDialog<T>(2, Integer.MAX_VALUE, "X", "Y") {
            ...
            public void addDialogComponents() {
                ...
                addDialogComponent("Options",
                                   ...
                                   new DialogComponentStringSelection(DoGDetector3NodeFactory.createOutOfBoundsModel(),
