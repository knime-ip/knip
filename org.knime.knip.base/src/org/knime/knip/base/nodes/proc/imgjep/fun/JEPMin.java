 ...
 */
public class JEPMin extends PostfixMathCommand implements ImgOpEvalRequired {
    ...
    public Double min(final Number d1, final Number d2) {
        return new Double(Math.min(d1.doubleValue(), d2.doubleValue()));
    }

    public Object min(final Object param1, final Object param2) throws ParseException {
        if ((param1 instanceof Number) && (param2 instanceof Number)) {
            return min((Number)param1, (Number)param2);
        } else if ((param1 instanceof Img) || (param2 instanceof Img)) {
            return m_imgOpEval.doImgBinaryOperation(param1, param2, new RealMin());
        }
