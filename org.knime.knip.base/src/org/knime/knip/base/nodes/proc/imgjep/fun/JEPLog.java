 ...
 */
public class JEPLog extends NaturalLogarithm implements ImgOpEvalRequired {
    ...
    @Override
    public Object ln(final Object param) throws ParseException {
        if (param instanceof Number) {
            return super.ln(param);
        } else if (param instanceof Img) {
            return m_imgOpEval.doImgUnaryOperation((Img)param, new RealLog());
        }
