 ...
 * @param <V>
 */
public class AlignerNodeFactory2<T extends RealType<T>, V extends RealType<V>>
    ...
    protected TwoValuesToCellNodeDialog<ImgPlusValue<T>, ImgPlusValue<V>> createNodeDialog() {
        return new TwoValuesToCellNodeDialog<ImgPlusValue<T>, ImgPlusValue<V>>() {
            ...
            public void addDialogComponents() {
                ...
                addDialogComponent("Options", "Start coordinates", new DialogComponentSubsetSelection2(
