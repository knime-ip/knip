...
import org.knime.knip.base.nodes.proc.binner.PixelBinnerNodeFactory;
...
public class ProcNodeSetFactory implements NodeSetFactory {
    ...
    public Collection<String> getNodeFactoryIds() {
        ...
        m_nodeFactories.put(PixelBinnerNodeFactory.class.getCanonicalName(), "/community/knip/image/process");
