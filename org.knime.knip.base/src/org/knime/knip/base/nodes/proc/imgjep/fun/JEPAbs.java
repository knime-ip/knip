 ...
 */
public class JEPAbs extends Abs implements ImgOpEvalRequired {
    ...
    @Override
    public Object abs(final Object param) throws ParseException {
        if (param instanceof Number) {
            return super.abs(param);
        } else if (param instanceof Img) {
            return m_imgOpEval.doImgUnaryOperation((Img)param, new RealAbs());
        }
