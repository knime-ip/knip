...
public class LocalThresholderNodeFactory2<T extends RealType<T>> extends SlidingWindowOperationNodeFactory<T, BitType> {
    ...
    protected SlidingWindowOperationNodeDialog<T> createNodeDialog() {
        return new LocalThresholderNodeDialog2<T>();
    }

    @Override
    public AbstractSlidingWindowOperationNodeModel<T, BitType> createNodeModel() {
        return new LocalThresholderNodeModel2<T>();
    }
