...
/**
 * Factory class to produce the Histogram Operations Node. Uses {@link DialogComponentSubsetSelection2} instead of
 ...
 * @param <L>
 */
public class LabelingOrthoCropperNodeFactory2<L extends Comparable<L>>
    ...
    private static SettingsModelSubsetSelection2 createSubsetSelectionModel() {
        return new SettingsModelSubsetSelection2("subset_selection");
    }
    ...
    public ValueToCellNodeModel<LabelingValue<L>, LabelingCell<L>> createNodeModel() {
        return new ValueToCellNodeModel<LabelingValue<L>, LabelingCell<L>>() {
            ...
            private final SettingsModelSubsetSelection2 m_subsetSel = createSubsetSelectionModel();
            ...
            protected LabelingCell<L> compute(final LabelingValue<L> cellValue) throws Exception {
                ...
                if (m_subsetSel.isCompletelySelected()) {
                    ...
                    // ImgLabeling
                    @SuppressWarnings("unchecked")
                    final MergeLabelings<L> mergeOp = new MergeLabelings<L>(
                            Util.getTypeFromInterval(((ImgLabeling<L, ? extends IntegerType<?>>)lab).getIndexImg()),
                    ...
                    if (subLab.length == totalSize) {
                        throw new KNIPException(
                                "There is no dimension left to create a new image in Labeling Cropper!");
                    }
