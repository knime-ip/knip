 ...
 */
public class LocalThresholderNodeDialog2<T extends RealType<T>> extends SlidingWindowOperationNodeDialog<T> {
    ...
    public void addDialogComponents() {
        ...
        final SettingsModelString method = LocalThresholderNodeModel2.createThresholderModel();
        ...
        final SettingsModelDouble c = LocalThresholderNodeModel2.createCModel();
        addDialogComponent("Options", "Parameters", new DialogComponentNumber(c, "C", 0.01));
        final SettingsModelDouble r = LocalThresholderNodeModel2.createRModel();
        addDialogComponent("Options", "Parameters", new DialogComponentNumber(r, "R", 0.01));

        final SettingsModelDouble contrastThreshold = LocalThresholderNodeModel2.createContrastThreshold();
        ...
        method.addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(final ChangeEvent arg0) {
                final LocalThresholdingMethodsEnum2 methodEnum =
                        Enum.valueOf(LocalThresholdingMethodsEnum2.class, method.getStringValue());
