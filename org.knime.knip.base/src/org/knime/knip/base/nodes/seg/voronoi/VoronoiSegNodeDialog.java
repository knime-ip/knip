...
public class VoronoiSegNodeDialog extends DefaultNodeSettingsPane {
    ...
    public VoronoiSegNodeDialog() {
        super();
        addDialogComponent(new DialogComponentColumnNameSelection(VoronoiSegNodeModel.createImgColModel(),
                "Image to work on: ", 0, ImgPlusValue.class));

        addDialogComponent(new DialogComponentColumnNameSelection(VoronoiSegNodeModel.createSeedLabelingModel(),
                "Seed regions: ", 0, LabelingValue.class));

        addDialogComponent(new DialogComponentNumber(VoronoiSegNodeModel.createThresholdModel(),
