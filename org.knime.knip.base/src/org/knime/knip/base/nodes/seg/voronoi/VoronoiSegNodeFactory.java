 ...
 */
public class VoronoiSegNodeFactory<T extends RealType<T>, L extends Comparable<L>> extends
        NodeFactory<VoronoiSegNodeModel<T, L>> {
    ...
    public NodeDialogPane createNodeDialogPane() {
        return new VoronoiSegNodeDialog();
    }
     ...
     */
    @Override
    public VoronoiSegNodeModel<T, L> createNodeModel() {
        return new VoronoiSegNodeModel<T, L>();
    }
