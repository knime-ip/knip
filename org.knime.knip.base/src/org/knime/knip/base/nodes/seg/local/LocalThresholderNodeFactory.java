...
public class LocalThresholderNodeFactory<T extends RealType<T>> extends ImgPlusToImgPlusNodeFactory<T, BitType> {
    ...
    @Override
    protected LocalThresholderNodeDialog<T> createNodeDialog() {
        return new LocalThresholderNodeDialog<T>();
    }

    @Override
    public LocalThresholderNodeModel<T> createNodeModel() {
        return new LocalThresholderNodeModel<T>();
    }
