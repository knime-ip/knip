...
public class ContourDetectorNodeFactory<T extends RealType<T>, L extends Comparable<L>> extends
    ...
    @Override
    public ContourDetectorNodeModel<T, L> createNodeModel() {
        return new ContourDetectorNodeModel<T, L>();
    }

    @Override
    public NodeView<ContourDetectorNodeModel<T, L>> createNodeView(final int viewIndex,
                                                                   final ContourDetectorNodeModel<T, L> nodeModel) {
        return null;
    }
