...
public class SigmaFilterNodeDialog<T extends RealType<T>> extends ImgPlusToImgPlusNodeDialog {
    ...
    public void addDialogComponents() {
        ...
        addDialogComponent("Options", "Out of bounds strategy", new DialogComponentOutOfBoundsSelection(
                SigmaFilterNodeModel.createOutOfBoundsModel()));
        ...
        addDialogComponent("Options", "Parameters", new DialogComponentNumber(sigmaFactor, "Sigma Factor", 0.01));

        final SettingsModelDouble pixelFraction = SigmaFilterNodeModel.createPixelFractionModel();
        addDialogComponent("Options", "Parameters", new DialogComponentNumber(pixelFraction, "Pixel Fraction", 0.01));

        addDialogComponent("Options", "Parameters",
                           new DialogComponentBoolean(SigmaFilterNodeModel.createOutlierDetectionModel(),
                                   "Outlier Detection"));
    }
