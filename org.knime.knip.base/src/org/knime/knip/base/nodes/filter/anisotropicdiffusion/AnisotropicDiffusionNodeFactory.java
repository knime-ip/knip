 ...
 */
public class AnisotropicDiffusionNodeFactory<T extends RealType<T> & NativeType<T>> extends
    ...
    protected ImgPlusToImgPlusNodeDialog<T> createNodeDialog() {
        return new AnisotropicDiffusionNodeDialog<T>();
    }
    ...
    public ImgPlusToImgPlusNodeModel<T, T> createNodeModel() {
        return new AnisotropicDiffusionNodeModel<T>();
    }
