...
public class SigmaFilterNodeFactory<T extends RealType<T>> extends ImgPlusToImgPlusNodeFactory<T, T> {
     ...
     */
    @Override
    protected SigmaFilterNodeDialog<T> createNodeDialog() {
        return new SigmaFilterNodeDialog<T>();
    }
     ...
     */
    @Override
    public SigmaFilterNodeModel<T> createNodeModel() {
        return new SigmaFilterNodeModel<T>();
    }
