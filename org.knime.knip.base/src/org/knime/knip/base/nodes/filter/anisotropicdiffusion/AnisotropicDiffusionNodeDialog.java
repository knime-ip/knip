...
public class AnisotropicDiffusionNodeDialog<T extends RealType<T>> extends ImgPlusToImgPlusNodeDialog<T> {
    ...
    public void addDialogComponents() {
        // select desired Diffusion Function and parameter kappa
        // Diffusion Function
        ...
        // Iterations
        final DialogComponent n =
                new DialogComponentNumber(AnisotropicDiffusionNodeModel.createIterationModel(), "Iterations", 1);
