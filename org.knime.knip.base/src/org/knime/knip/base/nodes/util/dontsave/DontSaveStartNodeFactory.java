...
public class DontSaveStartNodeFactory extends NodeFactory<DontSaveStartNodeModel> {
     ...
     */
    @Override
    public DontSaveStartNodeModel createNodeModel() {
     ...
     */
    @Override
    public NodeView<DontSaveStartNodeModel> createNodeView(final int viewIndex, final DontSaveStartNodeModel nodeModel) {
        return null;
    }
