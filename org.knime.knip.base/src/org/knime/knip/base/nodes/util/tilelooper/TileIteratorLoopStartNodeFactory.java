...
/**
 * Node factory for the tile loop start.
 *
        ...
        return new DefaultNodeSettingsPane() {
            {
                ...
                createNewGroup("Out of bounds strategy");
                addDialogComponent(new DialogComponentOutOfBoundsSelection(
                        TileIteratorLoopStartNodeModel.createOutOfBoundsModel()));
                closeCurrentGroup();
            }
        };
    }
