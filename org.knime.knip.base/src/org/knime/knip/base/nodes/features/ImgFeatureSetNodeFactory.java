 ...
 */
public class ImgFeatureSetNodeFactory<L extends Comparable<L>, T extends RealType<T>> extends
    ...
    protected FeatureSetProvider<ValuePair<IterableInterval<T>, CalibratedSpace>>[] getFeatureSetProviders() {
        return new FeatureSetProvider[]{new HaralickFeatureSetProvider<T>(),
