 ...
 */
public class HistogramCellViewFactory<T extends RealType<T> & NativeType<T>> implements CellViewFactory {
    ...
    public String getCellViewDescription() {
        return "This viewer shows the histogram of the currently selected image.";
    }
