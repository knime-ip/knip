...
public class ViewsNodeSetFactory implements NodeSetFactory {
    ...
    public Collection<String> getNodeFactoryIds() {
        m_nodeFactories.put(TableCellViewNodeFactory.class.getCanonicalName(), "/community/knip/views");
        m_nodeFactories.put(SegmentOverlayNodeFactory.class.getCanonicalName(), "/community/knip/views");
        m_nodeFactories.put(ImgParAdjustNodeFactory.class.getCanonicalName(), "/community/knip/views");
