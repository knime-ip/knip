 ...
 */
public class StructuringElementNodeFactory<T extends RealType<T>> extends DynamicNodeFactory<KernelCreatorNodeModel<T>> {

    private final Map<String, Class<?>> m_pool;

    public StructuringElementNodeFactory() {
        m_pool = createPool();
    }
    ...
    private Map<String, Class<?>> createPool() {
        ...
        pool.put("Box", BoxConfiguration.class);
        pool.put("Sphere", SphereConfiguration.class);
        return pool;
    }
