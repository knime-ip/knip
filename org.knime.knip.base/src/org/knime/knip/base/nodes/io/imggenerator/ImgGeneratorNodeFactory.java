 ...
 */
public class ImgGeneratorNodeFactory<T extends NativeType<T> & RealType<T>> extends
        DynamicNodeFactory<ImgGeneratorNodeModel<T>> {
     ...
     */
    @Override
    public ImgGeneratorNodeModel<T> createNodeModel() {
        return new ImgGeneratorNodeModel<T>();
    }
