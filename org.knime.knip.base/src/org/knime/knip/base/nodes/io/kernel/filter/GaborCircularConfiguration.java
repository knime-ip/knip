 ...
 */
public class GaborCircularConfiguration extends ImgConfiguration<FloatType> {
    ...
    public GaborCircularConfiguration() {
        initializeGui();
    }

    public GaborCircularConfiguration(final GaborCircularSetting setting) {
        this();
    ...
    protected void loadFromSetting(final GaborCircularSetting setting) {
    ...
    public void validate() throws InvalidSettingsException {
        try {
            ...
            m_setting =
                    new GaborCircularSetting((int[])m_jtfSupportRadius.getValue(), (double[])m_jtfScale.getValue(),
                            (double[])m_jtfFrequency.getValue());
...
class GaborCircularSetting extends SerializableSetting<Img<FloatType>[]> {
    ...
    public GaborCircularSetting(final int[] supportRadius, final double[] scale, final double[] frequency) {
        super();
    ...
    public Img<FloatType>[] get() {
        final Img<FloatType>[] kernels = new Img[m_supportRadius.length * m_scale.length * m_frequency.length];
        ...
        for (final int r : m_supportRadius) {
            for (final double s : m_scale) {
                for (final double f : m_frequency) {
                    final GaborCircular g = new GaborCircular(r, (float)s, (float)f);
