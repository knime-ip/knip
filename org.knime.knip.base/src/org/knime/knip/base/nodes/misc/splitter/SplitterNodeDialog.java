...
public class SplitterNodeDialog extends DefaultNodeSettingsPane {
    ...
    public SplitterNodeDialog() {
        ...
        addDialogComponent(new DialogComponentColumnNameSelection(SplitterNodeModel.createColumnModel(), "", 0, true,
                ImgPlusValue.class));
        closeCurrentGroup();

        createNewGroup("Dimension selection");
        final SettingsModelDimSelection dimSelection = SplitterNodeModel.createDimSelectionModel();
        addDialogComponent(new DialogComponentDimSelection(dimSelection, "Dimensions"));
        closeCurrentGroup();

        createNewTab("Advanced");

        final SettingsModelBoolean isAdvanced = SplitterNodeModel.createIsAdvancedModel();
        addDialogComponent(new DialogComponentBoolean(isAdvanced, "use advance settings"));
        final SettingsModelIntegerBounded[] models = SplitterNodeModel.createAdvancedModels();
        ...
        isAdvanced.addChangeListener(new ChangeListener() {
            @Override
