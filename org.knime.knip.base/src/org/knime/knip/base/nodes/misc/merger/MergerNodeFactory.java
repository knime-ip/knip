...
public class MergerNodeFactory extends NodeFactory<MergerNodeModel> {
     ...
     */
    @Override
    public MergerNodeModel createNodeModel() {
     ...
     */
    @Override
    public NodeView createNodeView(final int viewIndex, final MergerNodeModel nodeModel) {
        return new TableCellViewNodeView<MergerNodeModel>(nodeModel);
    }
