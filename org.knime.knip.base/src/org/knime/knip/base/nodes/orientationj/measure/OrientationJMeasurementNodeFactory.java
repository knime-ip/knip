...
/**
 * The node factory of the node which calculates OrientationJ features.
 *
...
public final class OrientationJMeasurementNodeFactory<T extends RealType<T>>
    ...
    protected ValueToCellsNodeDialog<ImgPlusValue<T>> createNodeDialog() {
        return new OrientationJMeasurementNodeDialog<T>();
    }
    ...
    public ValueToCellsNodeModel<ImgPlusValue<T>> createNodeModel() {
        return new OrientationJMeasurementNodeModel<T>();
    }
