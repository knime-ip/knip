 ...
 * 
 */
public class ImgMaxOperator<T extends RealType<T>> extends ImgPixOperator<T> {

    public ImgMaxOperator() {
        super("Max Image", "Max Image");
    }

    /**
     * @param label
     */
    public ImgMaxOperator(final GlobalSettings globalSettings) {
        super("Max Image", "Max Image", globalSettings);
    }
    ...
    public AggregationOperator createInstance(final GlobalSettings globalSettings,
        ...
        return new ImgMaxOperator<T>(globalSettings);
    }
    ...
    protected RealUnaryOperation<T, T> createTypeOperation() {
        return new RealUnaryOperation<T, T>() {
            ...
            public T compute(final T input, final T output) {
                output.setReal(Math.max(input.getRealDouble(), output.getRealDouble()));
                return output;
            }
    ...
    public String getDescription() {
        return "Calculates the max image.";
    }
