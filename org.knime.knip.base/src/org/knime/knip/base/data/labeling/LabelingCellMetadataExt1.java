 ...
 */
public class LabelingCellMetadataExt1 implements Externalizer<LabelingCellMetadata> {

    private static final NodeLogger LOGGER = NodeLogger.getLogger(LabelingCellMetadataExt1.class);
    ...
    public LabelingCellMetadata read(final BufferedDataInputStream in) throws Exception {
        ...
        // Read labeling metadata
        LabelingMetadata resMetadata = ExternalizerManager.<LabelingMetadata> read(in);
        ...
        return new LabelingCellMetadata(resMetadata, size, dimensions, thumbnail);
    }
     ...
     */
    @Override
    public void write(final BufferedDataOutputStream out, final LabelingCellMetadata obj) throws Exception {

        // Write Labeling Metadata
        ExternalizerManager.write(out, obj.getLabelingMetadata(), LabelingMetadata.class);
