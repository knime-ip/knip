...
abstract class AbstractSimpleJTextfieldDialogComponent extends DialogComponent {
     ...
     */
    public AbstractSimpleJTextfieldDialogComponent(final SettingsModelString stringModel, final String label) {
        this(stringModel, label, false, calcDefaultWidth(stringModel.getStringValue()));
    }
     ...
     */
    public AbstractSimpleJTextfieldDialogComponent(final SettingsModelString stringModel, final String label,
                                                   final boolean disallowEmptyString, final int compWidth) {
        super(stringModel);
    ...
    private void updateModel() throws InvalidSettingsException {
        if (m_disallowEmtpy && ((m_valueField.getText() == null) || (m_valueField.getText().length() == 0))) {
        ...
        ((SettingsModelString)getModel()).setStringValue(m_valueField.getText());
    }
