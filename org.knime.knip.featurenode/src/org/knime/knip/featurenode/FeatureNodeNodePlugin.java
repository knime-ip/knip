 ...
 */
public class FeatureNodeNodePlugin extends Plugin {
    // The shared instance.
    private static FeatureNodeNodePlugin plugin;

    /**
     * The constructor.
     */
    public FeatureNodeNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static FeatureNodeNodePlugin getDefault() {
        return plugin;
    }
