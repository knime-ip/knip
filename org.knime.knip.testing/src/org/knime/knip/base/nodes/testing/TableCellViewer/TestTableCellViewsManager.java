...
public final class TestTableCellViewsManager {
    ...
    private static final NodeLogger LOGGER = NodeLogger.getLogger(TestTableCellViewsManager.class);

    /**
     * @return the only instance of this class
     */
    public static TestTableCellViewsManager getInstance() {
        if (instance == null) {
            instance = new TestTableCellViewsManager();
        }
        return instance;
    }
