...
public interface ImgSource {
	 ...
	 * @throws Exception
	 */
	public List<CalibratedAxis> getAxes(Location loc, int currentSeries) throws Exception;
	...
	public ImgPlus<RealType> getImg(Location location, int currentSeries) throws Exception;
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public RealType getPixelType(final Location loc, final int currentSeries) throws FormatException, IOException;
